...
export default function ProjectListSkeleton() {
  ...
  return (
    <div className="min-h-screen projects-page w-full min-w-0 overflow-x-hidden">
      <div className="flex flex-col items-center self-stretch w-full min-w-0 pt-[200px] pb-[200px] box-border">
        <div className="flex flex-col gap-4 self-stretch w-full min-w-0 max-w-[1160px] mx-auto px-4 tablet:px-6 box-border">
          <div
        ...
        <div className="flex flex-col justify-center items-start self-stretch w-full min-w-0 pt-8 tablet:pt-12 desktop:pt-[49px] box-border">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="animate-pulse flex flex-col tablet:flex-row justify-center items-center gap-4 tablet:gap-6 self-stretch w-full min-w-0 relative px-4 tablet:px-6 box-border"
            >
              ...
              <div className="flex flex-col tablet:flex-row flex-1 w-full min-w-0 max-w-[1160px] justify-center items-center flex-wrap border-x border-[#46474A] gap-4 tablet:gap-6 py-4 tablet:py-6 box-border">
                ...
                <div className="flex flex-col justify-center items-center w-full min-w-0 tablet:w-[412px] tablet:min-w-[412px] h-[180px] tablet:h-[220px] desktop:h-[260px] px-4 order-1 tablet:order-2 box-border">
